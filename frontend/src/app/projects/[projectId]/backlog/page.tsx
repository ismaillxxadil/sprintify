      ...
      <div className="flex justify-between items-center mb-10">
        <div>
          <h1 className="text-3xl font-black text-[#1B3C53] flex items-center gap-3 uppercase tracking-tighter">
            <Archive size={32} /> {projectId} Backlog
          </h1>
          <p className="text-[#4A708B] text-sm mt-1 uppercase font-bold tracking-widest">Context: Project {projectId}</p>
        </div>
        <button className="bg-[#1B3C53] text-[#FAF5F0] px-6 py-3 rounded-2xl font-bold flex items-center gap-2 shadow-lg hover:opacity-90 transition-all text-xs uppercase"><Plus size={18} /> New Story</button>
      </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-[#C9BBAF]/10 text-[#4A708B] text-[10px] font-black uppercase tracking-widest">
              ...
              <th className="p-6">User Story</th>
